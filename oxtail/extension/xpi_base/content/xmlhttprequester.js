function {{ shortname }}_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
{{ shortname }}_xmlhttpRequester.prototype.contentStartRequest = function(details) {
    ...
    switch (scheme) {
        ...
        case "ftp":
            this.chromeWindow.setTimeout(
                {{ shortname }}_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
            break;
        default:
...
{{ shortname }}_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
{{ shortname }}_xmlhttpRequester.prototype.setupRequestEvent =
